...
function FormularioCategoria() {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch('https://aluraflixapi-murex.vercel.app/categorias');
  ...
  //     const response = await axios.post('https://aluraflixapi-murex.vercel.app/categorias', data);
  ...
  const onSubmit = async (data) => {
    try {
      if (editingCategoria) {
        ...
        const response = await axios.put(`https://aluraflixapi-murex.vercel.app/categorias/${editingCategoria.id}`, data);
        console.log(response.data);
        console.log(response.status);
   
        // data.categoriaColor = color;
        // const url = `https://aluraflixapi-murex.vercel.app/categorias/${editingCategoria.id}`;
        // await axios.put(url, data);
      } else {

        data.categoriaColor = data.categoriaColor || color;
        await axios.post('https://aluraflixapi-murex.vercel.app/categorias', data);
      }
      enqueueSnackbar(
        editingCategoria
  ...
  const deleteCategoria = async (id) => {
    try {
      await axios.delete(`https://aluraflixapi-murex.vercel.app/categorias/${id}`);
      fetchData();
      volverMain();
      forceUpdate();
